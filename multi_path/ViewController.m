...
- (IBAction)credits:(id)sender {
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Credits" message:@"mu1ti_path is brought to you by Ian Beer, Electra Team, JakeaJames, Qlin, and Markieeee:)" preferredStyle:UIAlertControllerStyleAlert];
